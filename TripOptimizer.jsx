...
const FLT_DEFAULTS={sort:"price",stops:"any",airlines:[],maxPrice:null,outWin:[],retWin:[],layover:"any",minLayover:"any",hideBasic:false,needChecked:false,outArr:[],retArr:[],noUS:false,exclAirports:[],maxDur:null};
...
function FilterBar({offers,flt,setFlt,shownCount,hasReturn,cur}){
  ...
  const dirty=flt.stops!=="any"||flt.airlines.length||flt.maxPrice!=null||flt.outWin.length||flt.retWin.length||flt.sort!=="price"||flt.layover!=="any"||flt.minLayover!=="any"||flt.hideBasic||flt.needChecked||flt.outArr.length||flt.retArr.length||flt.noUS||flt.exclAirports.length||flt.maxDur!=null;
  return (
